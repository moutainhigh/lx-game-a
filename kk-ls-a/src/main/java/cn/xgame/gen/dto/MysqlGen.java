...
	public static class GmUserDto implements SqlDto{		private String serial = null;
		private String name = null;

		public GmUserDto() {		}				/**		 * Copy new one		 */		public GmUserDto(GmUserDto src) {			this.serial = src.serial;
...
		public static String serialChangeSql( String x ) {			return "serial=" + "'"+x+"'";		}
